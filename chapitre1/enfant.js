...
function afficherEnfant(noeud, indice) {
    if(indice >= 0 && indice <= noeud.childNodes.length) { // Si l'indice est positif est inférieur ou égale au nombre des enfants du noeud
        if(noeud.nodeType === document.ELEMENT_NODE) { //Si le noeud est bien de type élément
